...
public class CardScreen extends FormScreen {
    ...
    private void renderCardForm() {
        ...
        // Render the form
        renderForm("Παρακαλούμε συμπληρώστε τα στοιχεία της κάρτας:",new Label[]{cardNumberLabel, expiryDateLabel, cvvLabel}, new TextField[]{cardNumberField, expiryDateField, cvvField});
    }
